    ...
    <div className="bg-black h-screen">
      ...
      <section className="bg-black flex flex-col items-center">
        ...
        <div className='mb-20 flex flex-col items-center'>
          ...
          <p className='text-xl text-slate-400 mb-8'>Technology & business enthusiast</p>
          <p className='text-xl text-slate-400 mb-8'>Experienced Solutions Engineer with programming experience</p>
